...
export const PRESETS: Preset[] = [
  ...
  {
    name: '9 Knights',
    description: 'Neon disco party.',
    players: [
      { color: '#6a00ff', pieceType: PIECE_LIBRARY.KNIGHT.leap },
      { color: '#ff00ff', pieceType: PIECE_LIBRARY.KNIGHT.leap },
      { color: '#ff0040', pieceType: PIECE_LIBRARY.KNIGHT.leap },
      { color: '#ff9500', pieceType: PIECE_LIBRARY.KNIGHT.leap },
      { color: '#ffff00', pieceType: PIECE_LIBRARY.KNIGHT.leap },
      { color: '#aaff00', pieceType: PIECE_LIBRARY.KNIGHT.leap },
      { color: '#00ff15', pieceType: PIECE_LIBRARY.KNIGHT.leap },
      { color: '#00ffff', pieceType: PIECE_LIBRARY.KNIGHT.leap },
      { color: '#0095ff', pieceType: PIECE_LIBRARY.KNIGHT.leap },
    ],
  },
];
