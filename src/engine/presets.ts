...
export const PRESETS: Preset[] = [
  ...
  },
  {
    ...
    players: [
      ...
      { color: '#ff00ff', pieceType: PIECE_LIBRARY.ZEBRA.leap },
      { color: '#ff0040', pieceType: PIECE_LIBRARY.ANTELOPE.leap },
      { color: '#ff9500', pieceType: { a: 5, b: 4 } },
      { color: '#ffff00', pieceType: { a: 6, b: 5 } },
      { color: '#aaff00', pieceType: { a: 7, b: 6 } },
      { color: '#00ff15', pieceType: { a: 8, b: 7 } },
      { color: '#00ffff', pieceType: { a: 9, b: 8 } },
      { color: '#0095ff', pieceType: { a: 10, b: 9 } },
    ],
  },
];
